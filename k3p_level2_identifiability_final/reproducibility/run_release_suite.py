...
def regeneration_commands(python: str, allow_uncommitted: bool) -> list[Command]:
    ...
    commands = [
        Command("cut_topology_graph_regeneration", [python,
            "cut_recovery/strong_crossbridge/topology_regeneration/generate_cut_topology.py",
            "--output",
            "release/work/regeneration_ephemeral/CORRECTED_CUT_TOPOLOGY_FRESH.json"],
            "CUT_TOPOLOGY_GRAPH_REGENERATION_PASS", 14_400),
        Command("cut_topology_graph_compare", [python,
            "cut_recovery/strong_crossbridge/topology_regeneration/verify_cut_topology_regeneration.py",
            "--candidate",
            "release/work/regeneration_ephemeral/CORRECTED_CUT_TOPOLOGY_FRESH.json",
            "--report",
            "cut_recovery/strong_crossbridge/topology_regeneration/CUT_TOPOLOGY_REGENERATION_REPORT.json"],
            "CUT_TOPOLOGY_GRAPH_REGENERATION_COMPARE_PASS", 14_400),
        Command("cut_topology_graph_mutations", [python,
            "cut_recovery/strong_crossbridge/topology_regeneration/test_cut_topology_regeneration_mutations.py"],
            "CUT_TOPOLOGY_GRAPH_REGENERATION_MUTATIONS_PASS", 600),
        ...
        Command("cut_global_transfer_manifest", [python,
            ...
            timeout_seconds=3_600),
        Command("tree_sunlet_literal_v2_build", [python,
            "three_port/literal_separator_v2/generate_literal_separator_v2.py"],
            timeout_seconds=3_600),
        Command("tree_sunlet_literal_v2_verify", [python,
            "three_port/literal_separator_v2/verify_literal_separator_v2.py"],
            timeout_seconds=3_600),
        Command("tree_sunlet_literal_v2_mutations", [python,
            "three_port/literal_separator_v2/test_literal_separator_v2_mutations.py"],
            timeout_seconds=3_600),
        Command("four_port_full_universe_producer", [python,
            "four_port_atlas/full_universe_replay/generate_full_four_port_replay.py"],
            "K3P_FULL_FOUR_PORT_UNIVERSE_REGENERATION_PASS", 43_200),
        Command("non_four_anchor_universe_producer", [python,
            "anchor_universe/generate_non_four_anchor_universe.py"],
            "K3P_NON_FOUR_ANCHOR_UNIVERSE_PASS", 14_400),
        ...
        Command("restoration_report_portability", [python,
            "restoration/test_restoration_report_portability.py"],
            "K3P_RESTORATION_REPORT_PORTABILITY_PASS", 600),
        Command("four_port_full_universe_structure_compare", [python,
            "four_port_atlas/full_universe_replay/verify_full_four_port_replay.py",
            "--structure-only"],
            "K3P_FULL_FOUR_PORT_INDEPENDENT_STRUCTURE_PASS", 14_400),
        Command("four_port_full_universe_mutations", [python,
            "four_port_atlas/full_universe_replay/test_full_four_port_mutations.py",
            "--report",
            "release/work/regeneration_ephemeral/FULL_FOUR_PORT_MUTATION_REPORT_FRESH.json"],
            "K3P_FULL_FOUR_PORT_COHERENT_MUTATIONS_PASS", 14_400),
        ...
        Command("probe_independent_replay", [python,
            ...
            timeout_seconds=14_400),
        Command("probe_full_semantic_replay", [python,
            "probes/verify_k3p_probes_semantic.py", "--output",
            "release/work/regeneration_ephemeral/K3P_PROBE_SEMANTIC_VERIFICATION_FRESH.json",
            "--mutations-output",
            "release/work/regeneration_ephemeral/K3P_PROBE_SEMANTIC_MUTATIONS_FRESH.json"],
        ...
        Command("global_infrastructure_verify", [python,
            "global_infrastructure/verify_global_infrastructure.py", "--report",
            "global_infrastructure/INDEPENDENT_VERIFICATION.json"],
            timeout_seconds=14_400),
        ...
        Command("clean_room_hardened_adversarial", [python,
            "clean_room/adversarial/hardened_cleanroom_reaudit.py"],
            "HARDENED_CLEANROOM_ADVERSARIAL_REAUDIT_PASS", 14_400),
