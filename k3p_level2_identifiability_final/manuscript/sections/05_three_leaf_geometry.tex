...
Brits et al.~\cite[Lemma~4.2]{BritsEtAl2026} prove the corresponding
tree--sunlet disjointness on their restricted continuous-time parameter
domain using four tree invariants.  The following six-circuit sum of squares
extends the separation to the entire principal positive domain \(\Dplus\).
