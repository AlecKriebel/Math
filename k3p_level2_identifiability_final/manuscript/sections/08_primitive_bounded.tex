...
target, and ``H14'' means a transported marginal of \eqref{eq:H14}.
...
SINK-0132 & source 5 & target 822; \texttt{0132} & \(24\to24\) & 1 & quartic\\
SINK-1023 & source 5 & target 822; \texttt{1023} & \(24\to24\) & 1 & quartic\\
\bottomrule
\end{longtable}
}
...
The 38 raw records belong to the fourteen named orbits; the final two table
rows are rank-\(24\) \(\theta_3\) sink-swap presentations.  Neither is a
...
strict upper bound.  The H21 target formulas are checked after saturation by
the declared nonzero physical factors; the other four targets are compressed
ordinary-sunlet projections.  A source-relative open containment cannot lie
inside the lower-dimensional target projection.
