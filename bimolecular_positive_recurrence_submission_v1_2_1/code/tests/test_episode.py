...
class EpisodeTests(unittest.TestCase):
    ...
    def test_scalar_envelope_is_pointwise_nondecreasing_in_M(self):
        for q in (Fraction(1, 7), Fraction(1, 2), Fraction(3, 2)):
            for p in (Fraction(1, 9), Fraction(2, 3), Fraction(1)):
                ...
                self.assertEqual(
                    increment,
                    q * p * (Fraction(5, 4) + Fraction(11, 3)),
                )
