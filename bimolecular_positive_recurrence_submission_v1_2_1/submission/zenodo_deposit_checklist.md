...
Use this only if the human author chooses to preserve Version 1.2.1 after the
bioRxiv posting. No Zenodo deposit or DOI exists at release time.

## Recommended object

Upload the curated, manifest-verified file
`bimolecular_positive_recurrence_submission_v1_2_1.zip` manually. Do not enable
...
- Verify the public tag `bimolecular-positive-recurrence-v1.2.1` and run
