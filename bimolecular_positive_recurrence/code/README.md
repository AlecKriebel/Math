...
This package accompanies Version 0.3 of *Positive Recurrence of Bimolecular Weakly Reversible Stochastic Reaction Networks with a Single Linkage Class*.
...
- every branch and boundary case in the exact scalar-envelope atlas;
...
- explicit boundary-face, absorbing-singleton, finite-class, parity, channel-marking, zero-length-path, and target-following-cycle calibrations.
...
Citation metadata, including the author's ORCID, is provided in `CITATION.cff`. The maintained Version 0.3 source is in the [Math repository](https://github.com/AlecKriebel/Math/tree/bimolecular-positive-recurrence-v0.3/bimolecular_positive_recurrence/code). No DOI has been assigned to this software release.
