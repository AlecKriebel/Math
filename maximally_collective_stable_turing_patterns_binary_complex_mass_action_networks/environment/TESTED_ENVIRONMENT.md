...
Release qualification for version 1.0.11 uses one pinned document route and one
...
1.0.11 qualification intentionally rebuilds all active PDFs with the single
