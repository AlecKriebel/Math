# Replay status for the 16 August 2026 adversarial repair
...
- all eight principal PDFs: 16-page manuscript, 12-page supplement, 2-page
  theorem summary, 5-page proof skeleton, and four one-page figures;
...
built independently with Tectonic and Biber and produced the expected 16- and
12-page documents. Numerical outputs are certified to the recorded tolerances,
