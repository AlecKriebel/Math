...
For every positive realization and every principal species set $I$ with $0<|I|<m$, $J_{I,I}$ is Hurwitz. Every strongly connected diagonal block is either a negative singleton, one of the two stable long cycles, or a non-singleton principal block of the boundary triad $\{X_1,X_m,Z\}$. The triad satisfies the cubic Routh--Hurwitz inequalities coefficientwise.
