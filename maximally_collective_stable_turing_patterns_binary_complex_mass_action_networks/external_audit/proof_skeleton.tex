...
$\operatorname{span}\{r_m\cos\xi\}$, cokernel
$\operatorname{span}\{\ell_m\cos\xi\}$, and transversality pairing
...
\]
A generalized vector would force $0=\widetilde\ell_m(L)^Tr_m$, so the scaled
