...
- A central weak-reversibility obstruction.
- Projected-injectivity sharpness.
- Any private T-ALG complexity statement.
- Constant-optimality of the stable diffusion--equilibrium trade-off.
- A universal nonlinear contrast gap above the linear threshold.
