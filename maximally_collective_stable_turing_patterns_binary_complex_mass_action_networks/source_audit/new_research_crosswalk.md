# New-research crosswalk

| Final claim | Research source | Reconstructed location |
|---|---|---|
| family, flux cone, realization space | `inherited_interface/` | `proof_audit/reaction_family.tex`, `flux_and_realization_space.tex` |
...
| local robustness | new derivation | `proof_audit/robustness.tex` |
