...
ax.set_ylabel(r'equilibrium scale separation $\chi_H$')
ax.set_title('Exact stable trade-offs and stationary lower hyperbolas')
ax.legend(frameon=False,fontsize=7.4,ncol=2)
ax.text(.02,.02,r'Dotted: stationary bound $\chi_D\chi_H=8(m-2)$'+'\nMarked endpoints: certified square-root scaling',transform=ax.transAxes,fontsize=7.5)
