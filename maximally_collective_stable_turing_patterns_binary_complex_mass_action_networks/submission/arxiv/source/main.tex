...
\[
 \eta_m(L)=
 \frac{\widetilde\ell_m(L)^T\mathsf H_m(L)\Delta_m r_m}
 {\widetilde\ell_m(L)^Tr_m}>0,
\]
and $c_m(L)<0$.  The branch and stability proof is the
...
\href{https://github.com/AlecKriebel/Math/tree/maximally-collective-stable-turing-v1.0.4/maximally_collective_stable_turing_patterns_binary_complex_mass_action_networks}{version 1.0.4 tagged release source tree}.
