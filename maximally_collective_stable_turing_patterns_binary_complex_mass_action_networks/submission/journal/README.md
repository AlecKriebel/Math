...
complete, and the author-confirmed funding, competing-interest, and
journal-exclusivity declarations are recorded below.
...
policy at <https://epubs.siam.org/artificial-intelligence> immediately before
submission, because portal and policy requirements can change.

## Human-supplied metadata and confirmations
...
- author name, affiliation, postal address, email, and supplied ORCID
  `0009-0001-9320-500X`;
- prior-dissemination/preprint, authorship, permissions, and any portal-specific
...
of the corrected release. They become upload-ready after the remaining
portal-specific metadata and publisher preview have been checked.
