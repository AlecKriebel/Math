...
separated; a rational coefficient multiplying a parameter is printed
unambiguously as $aA/b$ (or $aU/b$).
...
\ifsiadsreview
\begin{center}
\texttt{python independent\_verifier/}\\[-0.2em]
\texttt{verify\_symbolic\_certificates.py}
\end{center}
\noindent
\else
...
\[
 \begin{aligned}
 X_c&=\left\{u\in H_N^2:\int_0^\pi c^Tu=0\right\},\\
