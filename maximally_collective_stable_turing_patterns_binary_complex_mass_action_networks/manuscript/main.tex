...
$\operatorname{span}\{r_m\cos\xi\}$ and cokernel
$\operatorname{span}\{\ell_m\cos\xi\}$.  The parameter derivative applied to
the critical direction is $D_mr_m\cos\xi$, and its cokernel pairing is
...
\]
Its left nullvector is $\widetilde\ell_m(L)$.  If a generalized eigenvector
$v$ satisfied
$\mathsf H_m(L)(A_m-\Delta_m)v=r_m$, left multiplication by
$\widetilde\ell_m(L)^T$ would give
$0=\widetilde\ell_m(L)^Tr_m$, contradicting the displayed strict inequality.
...
\href{https://github.com/AlecKriebel/Math/tree/maximally-collective-stable-turing-v1.0.5/maximally_collective_stable_turing_patterns_binary_complex_mass_action_networks}{version 1.0.5 tagged release source tree}.
