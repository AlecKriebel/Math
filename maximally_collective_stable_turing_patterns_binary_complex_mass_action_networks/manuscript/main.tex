...
exchanged by reflection.  The stationary simple-eigenvalue theorem of
Crandall--Rabinowitz supplies the local bifurcating curve
...
\href{https://github.com/AlecKriebel/Math/tree/maximally-collective-stable-turing-v1.0.3/maximally_collective_stable_turing_patterns_binary_complex_mass_action_networks}{version 1.0.3 tagged release source tree}.
