...
The stationary fixed-mass linearization is Fredholm of index zero, with
kernel $\operatorname{span}\{r_m\cos\xi\}$, cokernel
$\operatorname{span}\{\ell_m\cos\xi\}$, and nonzero transversality pairing
$(\pi/2)\ell_m^TD_mr_m$.  A four-factor recurrence and a shifted-polynomial
...
$\operatorname{span}\{r_m\}$; the nonzero pairing
$\widetilde\ell_m(L)^Tr_m$ excludes a generalized eigenvector, so the scaled
