...
| Cubic sign | `m>=3`; adjoint-coordinate cubic numerator positive and denominator negative, hence `c_m<0` | Exact Fourier contractions; rational decomposition `R_m+C_m h_m`; shifted-positive denominators and clearing polynomial; harmonic-sum inequality | Exact symbolic identities plus all-dimensional coefficient sign proofs | `main.tex` 724-729; `supplement.tex` 385-465 |
