...
why the line-stabilizer hypothesis matters. The preprint and original
verification materials are archived at
\href{https://doi.org/10.5281/zenodo.22929486}{doi:10.5281/zenodo.22929486}.

OpenAI Codex was used in developing and checking the mathematical arguments,
writing exact verification programs, searching the literature, and preparing
the manuscript. Separate AI agents performed adversarial structural,
computational, and source reviews. These checks are not external peer
review or proof-assistant certification. The author is responsible for
the mathematical claims and the submitted text.
...
\url{https://kourovkanotebookorg.wordpress.com/}.
\end{thebibliography}
\end{document}
