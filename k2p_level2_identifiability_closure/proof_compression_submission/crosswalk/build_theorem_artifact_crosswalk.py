    ...
    claims: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "replay_artifacts": rows([
                ...
                ("work/rank_upper_certificates/verify_rank_upper_certificates.py", "executable symbolic-rank replay", True),
                ("work/rank_upper_certificates/syzygy_upper.py", "symbolic syzygy/minor module imported by the rank replay", True),
        ...
        },
        {
            ...
            "authoritative_artifacts": rows([
                ...
                ("proof_compression_submission/templates/PRINTED_CERTIFICATE_APPENDIX.json", "reader-facing printed-formula and worked-example derivative; not theorem authority", False),
            ...
            "replay_artifacts": rows([
                ...
                ("proof_compression_submission/templates/verify_printed_certificate_appendix.py", "reader-facing printed-formula and worked-example regression replay", False),
            ]),
            "mutation_artifacts": rows([
                ...
                ("package/referee/k2p_offline_sweep_portable/direct_closure_mutation_report.json", "exact production-verifier direct mutation report", True),
                ("proof_compression_submission/templates/test_printed_certificate_appendix_mutations.py", "reader-facing presentation regression; not theorem qualification", False),
                outer_mutation,
            ]),
            "environment_profile": "frozen-python-k2p-v1",
            "runtime": unknown_runtime(),
        },
        {
            ...
            "authoritative_artifacts": rows([
                ...
                ("work/cycle_three_port_closure/promotion/cycle_base_authoritative.jsonl.gz", "authoritative 13,440-row cycle base ledger", True),
                ("work/cycle_three_port_closure/promotion/cycle_full_authoritative.jsonl.gz", "authoritative 536,364-row cycle completion ledger", True),
                ("work/cycle_three_port_closure/promotion/cycle_promotion_certificate.json", "authoritative cycle promotion certificate", True),
            ...
            "producer_artifacts": rows([
                ...
                ("work/adversarial_proof_review/build_corrected_cycle_promotion.py", "authoritative cycle promotion producer", True),
            ...
            "replay_artifacts": rows([
                ...
                ("work/adversarial_proof_review/verify_corrected_cycle_promotion.py", "independent authoritative cycle replay", True),
                ("work/adversarial_proof_review/cycle_promotion_independent_verification.json", "authoritative cycle replay report", True),
            ...
            "mutation_artifacts": rows([
                ...
                ("work/adversarial_proof_review/test_cycle_promotion_mutations.py", "authoritative cycle mutation runner", True),
                ("work/adversarial_proof_review/cycle_promotion_mutation_certificate.json", "authoritative cycle mutation report", True),
        ...
        },
        {
            ...
            "authoritative_artifacts": rows([
                ("proof_compression_submission/article/main.tex", "current submission theorem and exact reconstruction authority", False),
                ("proof_compression_submission/output/K2P_SAME_Principal_Domain_Article.pdf", "rendered current theorem authority", False),
                ("work/global_theorem_closure/promotion_manuscript/K2P_SAME_PROMOTION_MANUSCRIPT.md", "machine-bound theorem-closure companion aligned with article R1--R8; not current submission proof authority", True),
        ...
        },
        {
            ...
            "authoritative_artifacts": rows([
                ("proof_compression_submission/article/main.tex", "current continuous-time classification and reconstruction proof", False),
                ("proof_compression_submission/output/K2P_SAME_Principal_Domain_Article.pdf", "rendered current continuous-time authority", False),
                ...
                ("work/global_theorem_closure/promotion_manuscript/K2P_SAME_PROMOTION_MANUSCRIPT.md", "machine-bound continuous-time closure companion aligned with the article; not current submission proof authority", True),
            ]),
            "producer_artifacts": rows([
        ...
        },
        {
            ...
            "mutation_artifacts": rows([
                ("work/weak_sharpness_audit/test_mutations.py", "current exact-typed sharpness mutation runner with clean baseline and output negative controls", True),
                ("work/weak_sharpness_audit/mutation_report.json", "current exact-typed sharpness mutation report", True),
...
def render_markdown(value: dict[str, Any]) -> str:
    ...
    lines.extend([
        ...
        "- Versioned annotated source tag: `k2p-same-biorxiv-v1.0.5`.",
