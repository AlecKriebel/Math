...
|---|---|---|
| Fixed mixed-graph convention and primitive supports | `primary/certificates/{core_universe,support_universe}.json`; `reviews/root_probe/*_certificate.json` | `python reviews/final_standard_convention/verify_conventions.py --check-bundled`; `python reviews/root_probe/verify_active_structural.py` |
