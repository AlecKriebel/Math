# Final human checklist — Systematic Biology

- [ ] I read the complete main manuscript and supplement.
- [ ] I confirm that Systematic Biology is the only journal considering this manuscript.
- [ ] I confirm the title, name, affiliation, email, and ORCID.
- [ ] I confirm the Research Article selection.
- [ ] I confirmed the current official author instructions on the day of submission.
- [ ] I inserted a real Zenodo DOI/reviewer link for the release archive; no placeholder remains.
- [ ] I confirmed whether ScholarOne requires a Dryad record for this nonempirical theorem paper.
