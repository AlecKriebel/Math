...
def main() -> None:
    ...
    build(
        ...
        [
            ...
            ("repair/FINAL_RELEASE_AUDIT.md", ROOT / "repair/FINAL_RELEASE_AUDIT.md"),
            ("repair/reviews/SHARPNESS_GATE_REVIEW.md", ROOT / "repair/reviews/SHARPNESS_GATE_REVIEW.md"),
            ("repair/reviews/MANUSCRIPT_FINAL_REVIEW.md", ROOT / "repair/reviews/MANUSCRIPT_FINAL_REVIEW.md"),
            ("repair/reviews/MANUSCRIPT_FINAL_REREVIEW.md", ROOT / "repair/reviews/MANUSCRIPT_FINAL_REREVIEW.md"),
