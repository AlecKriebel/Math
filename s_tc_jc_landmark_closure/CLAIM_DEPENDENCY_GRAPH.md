...
| D | One standard semi-directed convention; `S_TC` membership and primitive cores | OPEN |
...
| U | Exhaustive duplicate-free primitive level-2 generator universe | OPEN |
...
| S | Marginal submersion and coherent arbitrary-subdivision promotion | OPEN |
| Q | Structural root-to-incoming-port reduction | OPEN |
