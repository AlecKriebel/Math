...
This package accompanies Version 1.1 of *Positive Recurrence for Single-Linkage Bimolecular Weakly Reversible Stochastic Reaction Networks*.
...
`CITATION.cff`. The maintained Version 1.1 source is in the
[Math repository](https://github.com/AlecKriebel/Math/tree/bimolecular-positive-recurrence-v1.1/bimolecular_positive_recurrence_submission_v1_1/code).
