# arXiv metadata candidate

This is a preparation sheet only. It is not evidence of submission,
endorsement, moderation, or acceptance.
...
> reviewer supplement. This is an unrefereed preprint.
...
Before any deposit, recheck arXiv's current duplicate-posting, version,
licensing, and journal-preprint rules. Corrections to an arXiv posting should
normally be submitted as a new version of the same record rather than as a new
paper.
