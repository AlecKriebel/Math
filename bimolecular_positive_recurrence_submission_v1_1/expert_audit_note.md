...
Version 1.1 submission candidate. It is not a substitute for reading the
...
The propositions and their proofs remain in the manuscript. Interface details
moved out of the paper are retained in
...
Release hashes, the fresh-clone environment, and the complete console
transcript are recorded under `validation/`; durable file hashes are in
`supplement/MANIFEST.sha256`. The focused mathematical and primary-source
replays are in `supplement/v1_1_mathematical_audit.md` and
