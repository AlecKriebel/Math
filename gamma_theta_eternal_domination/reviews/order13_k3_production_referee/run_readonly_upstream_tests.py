#!/usr/bin/env python3
"""Run the frozen production tests that do not mutate repository sources."""
...
def main() -> int:
    specification = importlib.util.spec_from_file_location(
        "order13_k3_production_frozen_tests", TEST_FILE
    )
    if specification is None or specification.loader is None:
        raise AssertionError("could not load the frozen production tests")
