#!/usr/bin/env python3
"""Run repaired frozen tests that do not mutate repository source files."""
...
def main() -> int:
    specification = importlib.util.spec_from_file_location(
        "order13_k3_production_repaired_frozen_tests", TEST_FILE
    )
    if specification is None or specification.loader is None:
        raise AssertionError("could not load repaired frozen tests")
