...
keller_python=${KELLER_DN1CC_PYTHON:-/Users/alec/Documents/Math/.venv/bin/python}
output_file=$(mktemp)
...
grep -Fx "D4_DN1CC_HOSTILE_AUDIT_EXACT_PASS" "$output_file" >/dev/null
...
echo "D4_DN1CC_HOSTILE_AUDIT_STRICT_PASS"
