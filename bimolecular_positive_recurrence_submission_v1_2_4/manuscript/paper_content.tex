...
that weak reversibility implies positive recurrence.  We prove it for finite bimolecular networks with
...
degeneration.  For \(r\ge2\), consider the unit-rate cycle
\[
...
can decay super-exponentially in the number \(r+1\) of complexes even when all
