# bioRxiv upload instructions — Version 1.2.4
...
Do not create or enter a DOI or use a repository tag as one. bioRxiv generates
the preprint DOI automatically when the author gives final approval. New
records use prefix `10.64898`; the approval date forms part of the suffix, and
the DOI resolver may lag the eventual posting by up to 24 hours.
...
If approval occurs after 22 August 2026 or the public status changes, stop and
prepare a successor release with matching manuscript, bibliography, metadata,
access dates, PDFs, and hashes. Do not mutate the Version 1.2.4 tag.
