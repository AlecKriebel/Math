...
- Check that the manuscript accurately reports the live official record for
  ...
  last rechecked on 22 August 2026.
...
- Test the lifted state-cycle lemma and its conclusion that every population
  reachability set is already a closed communicating class under weak
  reversibility.
...
- Check the source-specific comparison with the Anderson–Cappelletti–Kim
  ...
  hypothesis.
- Verify the displayed definition of their entropy-like function and the
  exact Example 4.1 generator drift before comparing it with the marked
  log-factorial potential.
- Check the published Section 6 tier/path/Foster chain and the Section 6.1
  boundary case, including the exclusion of $2S_v$ and the resulting
  source-rate role of $S_v$. Internal numbering differs from the arXiv version.
...
- Check that the theorem's state-space formulation follows correctly from
  symmetry of population accessibility and does not extend the
  positive-recurrence claim beyond one linkage class.
...
- Check the priority note's description of the publicly announced
  ...
  was located as of 22 August 2026.
