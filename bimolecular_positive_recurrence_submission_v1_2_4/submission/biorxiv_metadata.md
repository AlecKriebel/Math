...
This sheet prepares Version 1.2.4 for bioRxiv. It is not evidence of screening,
...
**DOI:**
Do not create or enter a DOI. bioRxiv generates one automatically at final
author approval; new records use prefix `10.64898`, and the DOI may not resolve
until after the preprint is posted.

**Abstract:**

Stochastic mass-action reaction networks are chemical-master-equation models
of low-copy-number biochemical systems. Anderson and Kim conjectured that
weak reversibility implies positive recurrence. We prove this for finite bimolecular networks with one
...
The tagged Version 1.2.4 package contains the standalone verifier, tests,
canonical output, release manifest, manuscript source, supplementary note,
and reproducibility record:
<https://github.com/AlecKriebel/Math/tree/bimolecular-positive-recurrence-v1.2.4/bimolecular_positive_recurrence_submission_v1_2_4>.
...
model, date, access-route, use, checking, and responsibility details through 22
...
Repository versions 0.3, 1.0, 1.1, 1.2, 1.2.1, 1.2.2, 1.2.3, and 1.2.4 are publicly accessible as
...
announced two-species manuscript has appeared. If uploading after 22 August 2026,
