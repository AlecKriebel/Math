...
5. Preview the record, check the files and metadata, then publish when ready. Use 2026-09-23 as the first-publication date for this public repository version, or adjust it if the actual first public posting differs.

Author: Alec Kriebel, independent researcher, ORCID 0009-0001-9320-500X. License: CC BY 4.0 for the paper and prose, with MIT for code as stated in LICENSE.md inside the archive. Do not mark the preprint as externally peer-reviewed.

There is no need to create a GitHub Release for this upload. This repository's GitHub–Zenodo integration may create a separate DOI from a release; the prepared package is intended for this manual deposit instead.

Official instructions checked on 2026-09-23: https://help.zenodo.org/docs/deposit/create-new-upload/ and https://developers.zenodo.org/ . A DOI identifies a deposited version, not a certification of mathematical correctness or first priority.
