...
\]
Consequently the complete simple-multiplicity, central-rank, Markov-weight,
and branching arithmetic permits every even \(d\); a four-divisibility
obstruction must use strict tensor locality.
