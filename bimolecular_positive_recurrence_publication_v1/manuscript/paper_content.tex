...
permanently toward ever-larger populations.  We prove this stability, for
every choice of positive reaction rates, when the network is weakly
reversible, has one linkage class, and no reaction complex contains more than
two molecules.  This removes an additional pure-species condition required
by the previous theorem.  The proof follows the target produced by each
reaction and measures the population remaining after that target is
subtracted.  Multiple linkage classes and reactions involving more than two
molecules remain open.
\end{abstract}
\else
\begin{abstract}
