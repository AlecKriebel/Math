...
$\beta_m\downarrow0$, and hence

\[
 D_0(m,A)\longrightarrow
 d_A+\alpha_m
 \frac{\kappa_0}{\kappa_0+\kappa_1m}\log m>0.
\]
...
- finite expected entrance into a closed class from every nonclosed initial
  state.
