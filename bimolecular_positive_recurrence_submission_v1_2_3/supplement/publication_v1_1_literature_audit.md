...
> **Version 1.2.1 locator corrigendum (16 August 2026).** The internal
> locators recorded below are those of arXiv Version 2, not the published JAP
> typesetting. In the published article, the corresponding tier inclusion is
> (9), strict descent is Lemma 6.2(ii), sampled-chain assembly is Lemma 6.3,
> reaction-word construction is Lemma 6.4, and the boundary equations are
> (17)--(18). The current manuscript therefore uses stable section-level
> locators. The historical Version 1.1 audit text is retained below to preserve
> which source version was originally checked.
...
the official arXiv Version 2. They were renumbered in the published article,
as recorded in the corrigendum above.

### Exact dependency map

| ACK arXiv-v2 location | Exact role |
|---|---|
...
### Historical Version 1.1 recommended replacement paragraph
...
The following was the Version 1.1 arXiv-v2 locator and is retained only as a
historical record; the current manuscript uses section-level published
locators.
