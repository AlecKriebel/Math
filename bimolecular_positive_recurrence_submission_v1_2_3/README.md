...
## Version 1.2.3 submission candidate

This directory is the unrefereed Version 1.2.3 submission candidate frozen on
17 August 2026. It is prepared first for possible deposit in bioRxiv Systems
...
Version 1.2.3 is a separate, superseding patch release. Versions 0.3, 1.0,
1.1, 1.2, 1.2.1, and 1.2.2 and their Git history remain unchanged. The Version
1.2.2-to-1.2.3 relationship is recorded in
`preservation/VERSION_1.2.2_PROVENANCE.md`.
...
- `audit/`: preserved earlier audits and the focused Version 1.2.3 editorial
  and release audit.
...
Generative-AI systems were used materially from 5--17 August 2026. The
