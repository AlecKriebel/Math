...
This sheet prepares Version 1.2.3 for bioRxiv. It is not evidence of screening,
...
The tagged Version 1.2.3 package contains the standalone verifier, tests,
...
Repository versions 0.3, 1.0, 1.1, 1.2, 1.2.1, 1.2.2, and 1.2.3 are publicly accessible as
...
announced two-species manuscript has appeared. If uploading after 17 August 2026,
