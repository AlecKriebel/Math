...
and contains **1,332 pending queries**, one for every explicitly named source
...
All 66 source/audit files are reached by the default `CyclicBell` build target.
...
required. Until then, all endpoints—including the new model-value, binary
privacy/minimality and characteristic-polynomial candidates—remain uncertified.
