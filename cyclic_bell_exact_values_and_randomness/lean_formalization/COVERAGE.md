...
| Arbitrary-Hilbert conditional bound and all moments | [GeneralCoveragePermutation.lean](CyclicBell/GeneralCoveragePermutation.lean): `linear_commuting_hilbert_bound`, `linear_augmented_commuting_hilbert_bound`, `linear_permutation_local_moments_zero`, `linear_permutation_all_harmonics_invariant`. |
| Conditional simple spectra and complete correlator package | [GeneralCoverageWitness.lean](CyclicBell/GeneralCoverageWitness.lean): `conditional_permutation_simple_spectra`, `conditional_permutation_complete_harmonics`. Each root eigenspace is one-dimensional. |
