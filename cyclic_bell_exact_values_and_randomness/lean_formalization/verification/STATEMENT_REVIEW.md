...
This release preparation changes proof comments and reviewer tooling. It preserves the mathematical Lean code and records that preservation separately. Follow [REVIEWER_GUIDE.md](../REVIEWER_GUIDE.md) to inspect the formal statements directly.
