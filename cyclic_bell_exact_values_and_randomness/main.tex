...
Equality structure & No complete maximizing-face classification & Proves
the scalar phases, equal supported multiplicities for every attained finite-
dimensional tensor-product exact maximizer of the first augmented family, and
a conditional phase-permutation orbit with exact product hypotheses\\
...
The source-v3 SOS, with prefactor \(1/(2d)\), is short and load-bearing.
...
The theorem uses the source-v3 SOS to prove global optimality; merely
...
checks.  No external review, collaboration, or endorsement is claimed.
...
content of the source definition and the source-v3 SOS, with prefactor
\(1/(2d)\).  The source text adjacent to the canonical construction briefly
omits Alice's entrywise conjugation, while its theorem includes it.
