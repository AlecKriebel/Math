...
## Version 1.2.2 submission candidate

This directory is the unrefereed Version 1.2.2 submission candidate frozen on
...
Version 1.2.2 is a separate, superseding patch release. Versions 0.3, 1.0,
1.1, 1.2, and 1.2.1 and their Git history remain unchanged. The Version
1.2.1-to-1.2.2 relationship is recorded in
`preservation/VERSION_1.2.1_PROVENANCE.md`.
...
- `audit/`: preserved earlier audits, the Version 1.2.1 feedback audit, and the
  focused Version 1.2.2 status/submission audit.
