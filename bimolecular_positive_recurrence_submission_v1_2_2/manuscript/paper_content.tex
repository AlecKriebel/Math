...
result as of 16 August 2026.  The public descriptions concern two species and
...
\]
For \(n\ge2\), at \(x_n=(n,1,0)\), their unshifted entropy-like function has
generator drift \(\kappa_1n(2\log2-1)\to+\infty\).  For the marked construction,
...
\href{https://github.com/AlecKriebel/Math/tree/bimolecular-positive-recurrence-v1.2.2/bimolecular_positive_recurrence_submission_v1_2_2}{the tagged Version~1.2.2 repository directory}.
...
Generative-AI systems were used materially from 5--16 August 2026.  The tools
...
\href{https://github.com/AlecKriebel/Math/blob/bimolecular-positive-recurrence-v1.2.2/bimolecular_positive_recurrence_submission_v1_2_2/supplement/ai_use_full_statement.md}{supplement/ai\_use\_full\_statement.md}.
