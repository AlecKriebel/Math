# bioRxiv upload instructions — Version 1.2.2
...
Expected SHA-256 values for the sealed Version 1.2.2 files:

- `main_biorxiv.pdf`:
  `f2ca56833488250b6ccb14e232aa283b74cda3b9464c8a077d03aba680b95738`
- `supplementary_note.pdf`:
  `2be4de88ea9243258892cc7b0f4cb688715037756dddb00ef8ce3a7f435311a0`
...
If approval occurs after 16 August 2026 or the public status changes, stop and
prepare a successor release with matching manuscript, bibliography, metadata,
access dates, PDFs, and hashes. Do not mutate the Version 1.2.2 tag.
...
journal metadata. Do not rewrite the immutable Version 1.2.2 release.
