...
\]
This realizes the smallest-dimensional previously unresolved class in the
exceptional even-dimensional family left open in Lechner's 2026 classification
preprint, and that class corresponds to the ordinary-localization question
highlighted by Galindo, Hong, and Rowell for the
\(\cC(\mathfrak{sl}_3,6)\) Jones--Wenzl sequence.  Writing
\(\bbC^4\cong\bbC^2\otimes\bbC^2\), the associated
...
outputs, and sources supporting the computational claims.  The~
version-specific Zenodo record for this manuscript and its exact-verification
package is identified by
\href{https://doi.org/10.5281/zenodo.21971507}
{doi:10.5281/zenodo.21971507}~\cite{Kriebel2026Zenodo}.
...
\newblock Zenodo, version 1.1.3 (2026).
\newblock \href{https://doi.org/10.5281/zenodo.21971507}
