...
optimized Python cannot silently disable them.  The original discovery-era attachment is preserved in the
archival release; it is not part of this curated execution package.
"""
import sys
