#!/usr/bin/env python3
"""Regression tests for the noncentered integer degree obstruction."""
...
class Fixed41NoncenteredIntegerDegreeTest(unittest.TestCase):
    def test_exact_certificate(self) -> None:
        result = verify(CERTIFICATE, SOURCE)
        self.assertEqual(result["row_types_checked"], 855168)
