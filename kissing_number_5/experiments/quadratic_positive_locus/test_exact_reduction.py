...
from experiments.quadratic_positive_locus.verify_exact_reduction import (
    CERTIFICATE,
    VerificationError,
    verify,
)
...
class ExactReductionTest(unittest.TestCase):
    def test_exact_reduction(self) -> None:
    ...
    def test_optimized_mode_normal_and_tamper(self) -> None:
        module = (
            "experiments.quadratic_positive_locus.verify_exact_reduction"
        )
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            code = (
                ...
                "verify_exact_reduction import verify;"
        ...
        self.assertIn("wrong dimension", tampered.stderr)
