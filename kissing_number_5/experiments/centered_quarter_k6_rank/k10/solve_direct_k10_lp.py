#!/usr/bin/env python3
"""Numerically test the discovered rank-five K10 catalog against exact nu."""
...
def main() -> None:
    ...
    for line in lines[1:]:
        ...
        edges.append(fields[:45])
        features.append(fields[45:])
    ...
    target = np.concatenate(([1.0], nu / 13.0))
    result = linprog(
