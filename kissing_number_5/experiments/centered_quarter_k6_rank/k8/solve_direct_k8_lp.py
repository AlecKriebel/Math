#!/usr/bin/env python3
"""Numerically test the discovered rank-five K8 catalog against exact nu."""
...
def main() -> None:
    ...
    for line in lines[1:]:
        ...
        edges.append(fields[:28])
        features.append(fields[28:])
    ...
    target = np.concatenate(([1.0], 7.0 * nu / 195.0))
    result = linprog(
