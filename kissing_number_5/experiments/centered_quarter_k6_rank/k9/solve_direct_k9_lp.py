#!/usr/bin/env python3
"""Numerically test the discovered rank-five K9 catalog against exact nu."""
...
def main() -> None:
    ...
    for line in lines[1:]:
        ...
        edges.append(fields[:36])
        features.append(fields[36:])
    ...
    target = np.concatenate(([1.0], 7.0 * nu / 130.0))
    result = linprog(
