...
- **PROVED:** the event kernels, Palm laws, marked resolvent factorization,
  Poisson identity, and complete-graph equality;
...
The distinction between (alpha_C) and (eta_C) matters.  Treating the
...
4. checks (12), the Poisson equation (15), and the marked factorization
   (14);
5. certifies the strict signs (20) and (23);
6. reconstructs the forward (C) and dB fixation chains directly and
   checks (ho_U=1/(n\alpha_Uf)=m_U/n).
