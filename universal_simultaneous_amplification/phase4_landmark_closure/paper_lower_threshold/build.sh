...
export TZ=UTC
tectonic --keep-logs --keep-intermediates --outdir "$tmp_dir" "$paper_dir/main.tex"
install -m 0644 "$tmp_dir/main.pdf" \
  "$out_dir/simultaneous_amplification_below_three_halves.pdf"
pdfinfo "$out_dir/simultaneous_amplification_below_three_halves.pdf"
pdftoppm -png -r 150 \
  "$out_dir/simultaneous_amplification_below_three_halves.pdf" \
