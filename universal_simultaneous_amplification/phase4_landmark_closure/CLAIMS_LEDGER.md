...
| phase-4 paper/release | **NOT DONE** | no mission-level upper theorem yet | write only after theorem extraction, or publish lower theorem as open-threshold paper |
