...
the well-mixed replacement kernel is a strict nondegenerate local maximizer
within the full normalized loopless directed kernel polytope. Thus the result
...
author declares no competing interests. The accompanying reproducibility
package contains editable LaTeX source, exact rational and symbolic
verifiers, coefficient certificates, dependency pins, and a deterministic
bundle manifest.
