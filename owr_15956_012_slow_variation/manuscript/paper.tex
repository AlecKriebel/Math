...
\hypersetup{pdftitle={The odd-part ratio under slow variation: a note on the printed Hilberdink problem},pdfauthor={Alec Kriebel},pdfsubject={The printed slow-variation limit-existence question},pdfkeywords={multiplicative functions, slow variation, Hilberdink problem, OWR-15956-012}}
...
The paper, editable source, verification script and audit reports are available at \url{https://aleckriebel.github.io/Math/papers/odd-part-slow-variation/}.
