...
Final result: **fully validated**, with one optional low-priority improvement
to the hostile-bytecode marker's location. See:

- `report/R3_REREVIEW_REPORT.md` for the complete referee report;
- `records/STATIC_CERTIFIED_ROUTE_AUDIT.md` for the certified-route trace;
- `records/MATH_PDF_REGRESSION.md` for mathematical and rendered-PDF
  regression; and
- `records/COMMANDS.log` for the root command/status transcript.
