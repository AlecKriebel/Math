#!/usr/bin/env python3
"""Run bounded referee-authored checks against the third-revision package."""
...
OUTPUT = HERE / "results/fresh_spots_20260829"
...
def main() -> int:
    ...
    with transcript_path.open("x", encoding="utf-8") as transcript:
        transcript.write(json.dumps({
            "schema": "k3p-third-revision-referee-spots-v1",
    ...
    report = {
        "schema": "k3p-third-revision-referee-spot-suite-v1",
        "status": "PASS",
