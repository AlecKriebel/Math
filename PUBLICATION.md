...
That second-level timestamp is encoded in both source papers, both rendered
PDFs, and their web pages. It is the repository creation time returned by the
GitHub API. The initial commit is
