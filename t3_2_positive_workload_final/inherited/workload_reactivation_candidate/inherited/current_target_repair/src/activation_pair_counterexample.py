...
CHANNELS=(
    Channel('A_to_2A',(1,0),(2,0),Fraction(1),0),
    Channel('2A_to_A',(2,0),(1,0),Fraction(1),0),
    Channel('zero_to_AB',(0,0),(1,1),Fraction(1),1),
    Channel('AB_to_B',(1,1),(0,1),Fraction(1),1),
    Channel('B_to_zero',(0,1),(0,0),Fraction(1),1),
)
