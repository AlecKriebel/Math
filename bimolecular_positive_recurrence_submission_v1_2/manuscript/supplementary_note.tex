...
\date{Version 1.2 --- 16 August 2026}
...
the exact ACK Example~4.1 comparison included in the paper, and stationary
return-cycle normalization on a finite chain.
...
From the tagged Version~1.2 release directory, run:
