...
This sheet prepares Version 1.2 for bioRxiv. It is not evidence of screening,
...
The tagged Version 1.2 package contains the standalone verifier, tests,
canonical output, release manifest, manuscript source, focused reviewer
supplement, and reproducibility record:
<https://github.com/AlecKriebel/Math/tree/bimolecular-positive-recurrence-v1.2/bimolecular_positive_recurrence_submission_v1_2>.
...
Repository versions 0.3, 1.0, 1.1, and 1.2 are publicly accessible as
