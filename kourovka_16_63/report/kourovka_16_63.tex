...
\medskip
\noindent\textbf{AI attribution.} ChatGPT-6 Astra Pro solved the problem and
developed the construction, proof, and supporting scripts, as attributed by
the author. This edition was independently checked by Codex using separate
AI review agents and exact computational reproduction. These checks are not
external human peer review or a proof-assistant formalization.
