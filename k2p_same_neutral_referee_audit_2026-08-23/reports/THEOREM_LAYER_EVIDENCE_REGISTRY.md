...
- Producer/replayer code inspected:
  ...
  `a0ec39eda9b36f1c32b4fa3c67414fddd5cd68e4cf02659dd9d5182ce0c298af`.
  Output artifact: `work/rank_upper_certificates/rank_upper_replay.json`
  `c967917601f64803c96c1ba11cabc5fd3ea8d6021f9e55441c4210d9b886793d`.
- Observed submitted layer: `four_port_raw_structural_provenance`, exit 0,
  1.473628 s, stdout
...
- Authorities: `work/final_theorem_release/corrected_universe_certificate.json`
  `c80c8781b968b21e1b001d51b6e71650ee74a326bb8b3f0aa56fc5997c224663`;
  ...
  `8ec6b987422b0dd27a12d590e8aad4f2c34817e341024f0881000013baffc3df`;
...
- Producer/replayers inspected:
  ...
  output `work/restoration_sign_reclassification/corrected_restoration_replay_certificate.json`
...
- Authorities: `work/probe_coherence_corrected/probe_coherence_certificate.json`
...
- Producer/replayers inspected:
  `work/probe_coherence_corrected/build_probe_coherence_corrected.py`
...
- Executable producer/replayer code inspected:
  ...
  Output artifacts: `work/final_theorem_release/corrected_universe_independent_replay.json`
  `09a445c725caee1d7447382ea261869c91f4ae5ff6b8a995ab2e8a4cf3047325`;
...
- Observed command: `final_theorem_quick`, exit 0, 321.007619 s, log
  ...
  Fresh full stage `final_theorem_full_primitive_regeneration`, exit 0,
  4,911.443992 s, log
  `ba6a7f291fab27c5772cd15e9ceadfcf5fd36e751cd017635f901128c085ea92`;
  top-level full suite 22/22, 5,684.81 s, peak RSS 2,034,221,056 B, ledger
...
- Authorities: `work/domain_rooting_closure/PROOF.md`
  ...
  `d5e33c0ded1a8ae3ec3b7738e3166cb6d6afb7faff76c6bad0b759a0671a38cd`.
- Producer/replayers inspected:
  `work/domain_rooting_closure/verify_domain_rooting.py`
  `6c57043a801cba338ef90a68279bc078bda11d3ff25c40a3a53777aa9fd83f7b`;
  `work/bridge_marginal_closure/verify_bridge_marginal.py`
  `da9c56d0057b90ccf63588c4a8ce90ca4fd3ab8764013f2c44ffc66411079431`.
...
- Status/evidence type: **PASS**; mathematical and two-route exact computational
  evidence.
- Authorities: `work/weak_sharpness_closure/PROOF.md`
...
- The quick nested release log cited above is
  `28cbca4059deb3a43f1d8265cfefafd73164487a678f3d82ee49deb77faea492`.
- Full top-level suite: 22/22, exit 0, 5,684.81 s, peak RSS 2,034,221,056 B;
  ledger SHA-256
  `7146e52b0708ba7f459d27a9125203a973aab614668486eb985c908f16bf64cf`.
