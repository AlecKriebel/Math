...
| Rank | ID / code | Problem | EV | Difficulty | Proposed | Status | Turns | Chat | Findings |
|---:|---|---|---:|---:|---:|---|---|---|---|
| 1 | 30000990 / OWR-2040-002 | Gradient-Path Uniqueness in Persistence Pairings | 0.4602 | 3 | 2008 | claimed_solved | 1/5 | https://chatgpt.com/c/6ab2984f-d808-83e8-a1e7-a64bec9f638a | 2026-09-22: turn 1/5 CLAIMS FULL NEGATIVE RESOLUTION (counterexample: 4 vertices/3 edges, persistence pair (b, ac) with ZERO gradient paths); slot freed, awaiting user verification |
...
| 6 | 30003895 / OWR-16407-007 | All-Order Expansion of the Noncommutative $\Phi^4$ Model | 0.3000 | 3 | 2018 | claimed_solved | 3/5 | https://chatgpt.com/c/6ab2b1af-4db4-83e8-9d7c-9e1f5ea0c501 | 2026-09-22: turn 3/5 CLAIMS FULL POSITIVE RESOLUTION — cites arXiv:1807.02945 eq. (31) as the definition of I_λ(a), proves the expansion holds to every order in λ via Lagrange–Bürmann inversion, derives exact functional equations (35),(36),(38),(39); slot freed, awaiting user verification |
...
| 8 | 30001385 / OWR-4136-011 | Simplex Equality Cases in Convex Geometric Inequalities | 0.2976 | 3 | 2009 | claimed_solved | 1/5 | https://chatgpt.com/c/6ab2b529-dbfc-83e8-9dcc-e246207324e0 | 2026-09-22: turn 1/5 CLAIMS FULL AFFIRMATIVE RESOLUTION — equality forces K to be a simplex with all vertices on rS^{n−1}: proves extreme-point simplex decomposition lemma, exact second-moment identity, nonnegative deficit decomposition, interior-centroid argument forcing a single simplex; closes the equality-case gap left by Fradelizi–Paouris–Schütt; slot freed, awaiting user verification |
| 9 | 30003646 / OWR-15956-012 | Odd-Density Limits for Multiplicative Functions | 0.2924 | 3 | 2017 | claimed_solved | 1/5 | https://chatgpt.com/c/6ab2b6d0-8e40-83e8-9050-e88149812aa9 | 2026-09-22: turn 1/5 CLAIMS FULL RESOLUTION — limit always exists and equals 1/Σ f(2^k) (limsup argument via dilation by 2^K plus lower bound from monotonicity; A=∞ case gives 0); notes a likely source mismatch: the Oberwolfach report prints the slow-variation hypothesis but predicts the formula for the regular-variation version; slot freed, awaiting user verification |
