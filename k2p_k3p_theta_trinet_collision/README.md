...
- `combined-paper.tex` / `combined-paper.pdf`: unified K2P and K3P proof.
- `technical-summary.tex` / `technical-summary.pdf`: two-page technical overview.
...
A TeX installation with `latexmk`, `pdflatex`, and TikZ is sufficient:
