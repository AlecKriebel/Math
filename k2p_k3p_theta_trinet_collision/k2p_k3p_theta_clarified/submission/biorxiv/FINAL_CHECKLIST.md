...
- [ ] `bash submission/build_release.sh --output-dir /absolute/empty/output-directory --commit k2p-k3p-theta-v1.2.7 --version 1.2.7`
...
- [ ] The exact 40-character release commit is recorded in the replay archive
      and the tag `k2p-k3p-theta-v1.2.7` resolves to that commit.
