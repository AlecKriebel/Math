...
The current submission snapshot is version `1.2.5`, published under the Git tag
`k2p-k3p-theta-v1.2.5`. The tag, rather than the mutable `main` branch,
...
submission or release inputs. Frozen versions `1.2.4`, `1.2.3`, `1.2.2`,
