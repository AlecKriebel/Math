...
`RUN_REFEREE_REPLAY.sh`, `materials/src/test_k3p_semantic_mutations.py`, and
...
- whether unused certificate fields, untested branches, order dependence,
  ...
  create blind spots.
- whether the supplied semantic-mutation tests alter coupled labels and
  descriptors in ways that would have survived mere self-consistency checks,
