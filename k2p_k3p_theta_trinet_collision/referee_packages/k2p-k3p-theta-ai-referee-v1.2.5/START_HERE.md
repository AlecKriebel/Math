...
inputs for version 1.2.5 of *Exact Tree--Theta-Trinet Collisions under the
...
transcripts, executes both K2P and K3P semantic-mutation guards, regenerates
the compact K2P certificate in a disposable copy, and optionally rebuilds all
PDFs in a temporary directory. A passing replay is
