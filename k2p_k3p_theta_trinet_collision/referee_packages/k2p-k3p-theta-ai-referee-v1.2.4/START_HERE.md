...
inputs for version 1.2.4 of *Exact Tree--Theta-Trinet Collisions under the
...
transcripts, regenerates the compact K2P certificate in a disposable copy, and
optionally rebuilds all PDFs in a temporary directory. A passing replay is
